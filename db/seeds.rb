...
User.create(name: 'usersearch base', email: 'user_search@email.com', location_address: '2001 Colorado Blvd, Denver, CO 80205')
User.create(name: 'noadd user', email: 'no_add@email.com', location_address: nil)
